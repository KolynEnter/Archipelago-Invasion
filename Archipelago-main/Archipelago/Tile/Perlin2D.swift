...
public class Perlin2D: NSObject {
    ...
    private func fade(t:CGFloat) -> CGFloat {
    ...
    private func fastfloor(x:CGFloat) -> Int {
    ...
    private func octaveNoise(x:CGFloat, y:CGFloat, octaves:Int, persistence:CGFloat) -> CGFloat {
    ...
    public func perlinMatrix(width:Int, height: Int) -> [[CGFloat]] {
        ...
        for x in (0...width) {
            ...
            for y in (0...height) {
                let cx:CGFloat = CGFloat(x)/1024
                let cy:CGFloat = CGFloat(y)/1024
