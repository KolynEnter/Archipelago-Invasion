...
// The next attack damage * 0.8


struct AttackDown: BonusObject {
    ...
    func activate(buffManager: BuffManager) {
        buffManager.bonusers[carryUnit.battleIndex].addBonus(stat: .ATTACK, mag: Magnification(operation: .MULTIPLY, modifingRate: 0.8))
    }
