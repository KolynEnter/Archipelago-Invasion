...
// The next attack damage * 2

struct Polishing: BonusObject {
    ...
    func activate(buffManager: BuffManager) {
        buffManager.bonusers[carryUnit.battleIndex].addBonus(stat: .ATTACK, mag: Magnification(operation: .MULTIPLY, modifingRate: 2))
    }
