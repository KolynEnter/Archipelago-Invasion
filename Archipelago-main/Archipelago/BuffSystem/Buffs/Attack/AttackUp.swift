...
// The next attack damage * 1.2

struct AttackUp: BonusObject {
    ...
    func activate(buffManager: BuffManager) {
        buffManager.bonusers[carryUnit.battleIndex].addBonus(stat: .ATTACK, mag: Magnification(operation: .MULTIPLY, modifingRate: 1.2))
    }
